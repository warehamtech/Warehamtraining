 ...
 * HTML file (except the handful build/prerender.mjs still generates for
 * crawlers/link-unfurlers — see netlify/edge-functions/prerender-for-bots.ts)
 * is a key here instead. router.js looks a pathname up, sets the header
 * variant / <main> class / tab title synchronously, then dynamically
 * imports the module.
 *
