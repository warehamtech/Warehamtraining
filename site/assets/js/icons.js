/**
 * The icons the portal actually uses, inlined as SVG.
 *
 * The Next.js version pulled these from lucide-react. These are the same
 * Lucide glyphs (ISC licensed) drawn by hand from their path data, so the site
 * carries ~30 shapes instead of a package.
 */
...
const PATHS = {
  ...
  monitorPlay:
    '<path d="M10 7.75a.75.75 0 0 1 1.142-.638l3.664 2.249a.75.75 0 0 1 0 1.278l-3.664 2.25a.75.75 0 0 1-1.142-.639z"/><path d="M12 17v4"/><path d="M8 21h8"/><rect x="2" y="3" width="20" height="14" rx="2"/>',
  download:
  ...
  shuffle: '<path d="M2 18h1.4c1.3 0 2.5-.6 3.3-1.7l6.6-8.6c.8-1.1 2-1.7 3.3-1.7H22"/><path d="m18 2 4 4-4 4"/><path d="M2 6h1.4c1.3 0 2.5.6 3.3 1.7l6.6 8.6c.8 1.1 2 1.7 3.3 1.7H22"/><path d="m18 20 4-4-4-4"/>',
 ...
 * @param size  pixel size; 16 suits inline text, 20 a button, 24 a heading
 */
...
/** Icon for a LessonType, matching the sidebar legend. */
...
/** Icon for a lesson_blocks.block_type, used in the admin block editor. */
